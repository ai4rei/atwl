...
FOR %%v IN (bvector.c cstr.c dlgabout.c dlgtempl.c kvdb.c kvdb\win32ini.c macaddr.c md5.c memory.c regionui.c w32uxt.c xf_binhex.c xf_slash.c) DO CL %CLOPT% ..\snippets\%%v
