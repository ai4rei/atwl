...
IF "%1"=="clean" GOTO END
SET CLDEF=/DNDEBUG /DBVSVCS_WITH_MAINTEPARAMS /DBVSVCS_WITH_HANDLEREX
SET CLOPT=/O2x /GF %CLDEF%
SET LNOPT=/OPT:REF /OPT:ICF /OPT:NOWIN98
IF "%1"=="debug" SET CLDEF=/DDBG /DDEBUG /D_DEBUG /DBVSVCS_WITH_MAINTEPARAMS /DBVSVCS_WITH_HANDLEREX
