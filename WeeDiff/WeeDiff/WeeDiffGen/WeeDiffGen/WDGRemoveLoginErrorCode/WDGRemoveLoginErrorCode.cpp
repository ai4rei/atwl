...
#include "WDGRemoveLoginErrorCode.h"
...
{
    _T("Remove Login Error Code"),
    _T("Removes numeric error code in parentheses from login error messages."),
    _T("[UI]"),
    _T(""),
    _T("Ai4rei/AN"),
    1,
    0,
    { 0x6161b1ea, 0xea19, 0x11e1, { 0xa7, 0x78, 0x0, 0x22, 0x15, 0x64, 0x8a, 0x98 } },  /* guid */
    _T(""),
};
